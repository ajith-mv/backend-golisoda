            ...
            <div data-repeater-item>
                <div class="form-group row mb-5">
                    <div class="col-md-3">
                                            ...
                                            <select class="form-select  product-attr-select required" name="select2_input" data-control="select2" data-placeholder="Select an variation">
                                                <option></option>
                                ...
                                <div data-repeater-item>
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select product-attr-select1 required" name="variation_value" data-control="select2" data-placeholder="Select an variation value">
                                                <option></option>
                                            </select>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group pb-3">
                                                ...
                                                <button class="border border-secondary btn btn-icon btn-flex btn-light-danger" data-repeater-delete type="button">
                                                    <i class="fa fa-trash"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span><span class="path5"></span></i>
                                                </button>                                        
                                            </div>
                                        </div>
                                    </div>
