                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <select name="coupon_type" id="coupon_type" aria-label="Select a Coupon Type"
                                        ...
                                        <option value="4"
                                         ...
                                         <option value="5"
                                            @if (isset($info->coupon_type) && $info->coupon_type == '5') selected="selected" @endif>Brand
                                        </option>
                                    </select>
                                </div>
                            </div>
                                        ...
                                        @if (isset($couponTypeAttributes) && !empty($couponTypeAttributes))
                                            @foreach ($couponTypeAttributes as $item)
                                                <option value="{{ $item->id }}"
                                                    ...
                                                    selected="selected"
                                                    @elseif(isset($info->couponBrandData) && in_array($item->id, array_column($info->couponBrandData->toArray(), 'brand_id')))
