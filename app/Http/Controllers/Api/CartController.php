    ...
    public function addToCart(Request $request)
    {
        ...
        if (isset($checkCart) && !empty($checkCart)) {
            if ($type == 'delete') {
                ...
                $check_cart_variation_option = CartProductVariationOption::select('product_id')->whereIn('cart_i', $cart_ids)->whereIn('variation_option_id', $variation_option_ids)->where('product_id', $product_id)->groupBy('product_id')->havingRaw('COUNT(DISTINCT variation_option_id) = 2')->exists();
